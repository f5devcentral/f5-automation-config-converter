...
const ex1 = require('./monitor_tcp-half-open.json');

let json;

describe('Monitor TCP-Half-Open: ltm monitor tcp-half-open', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/monitor_tcp-half-open/monitor_tcp-half-open.conf']);
