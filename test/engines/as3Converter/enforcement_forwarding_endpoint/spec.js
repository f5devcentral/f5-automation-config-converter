...
const ex1 = require('./enforcement_forwarding_endpoint.json');

let json;

describe('Enforcement_Forwarding_Endpoint: pem forwarding-endpoint', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/enforcement_forwarding_endpoint/enforcement_forwarding_endpoint.conf']);
