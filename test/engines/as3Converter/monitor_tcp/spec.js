...
const ex1 = require('./monitor_tcp.json');

let json;

describe('Monitor TCP: ltm monitor tcp', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/monitor_tcp/monitor_tcp.conf']);
