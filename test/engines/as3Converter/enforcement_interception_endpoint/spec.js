...
const ex1 = require('./enforcement_interception_endpoint.json');

let json;

describe('Enforcement_Interception_Endpoint: pem interception-endpoint', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/enforcement_interception_endpoint/enforcement_interception_endpoint.conf']);
