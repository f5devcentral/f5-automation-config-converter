...
const ex1 = require('./ftp_profile.json');

let json;

describe('FTP_Profile: ltm profile ftp', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/ftp_profile/ftp_profile.conf']);
