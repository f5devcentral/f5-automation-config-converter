...
const ex1 = require('./http_acceleration_profile.json');

let json;

describe('HTTP_Acceleration_Profile: ltm profile web-acceleration', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/http_acceleration_profile/http_acceleration_profile.conf']);
