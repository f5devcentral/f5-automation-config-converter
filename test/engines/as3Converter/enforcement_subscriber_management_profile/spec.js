...
const ex1 = require('./enforcement_subscriber_management_profile.json');

let json;

describe('Enforcement_Subscriber_Management_Profile: pem profile subscriber-mgmt', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/enforcement_subscriber_management_profile/enforcement_subscriber_management_profile.conf']);
