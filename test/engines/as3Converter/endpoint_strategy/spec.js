...
const ex1 = require('./endpoint_strategy.json');

let json;

describe('Endpoint_Strategy: ltm policy-strategy', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/endpoint_strategy/endpoint_strategy.conf']);
