...
const ex1 = require('./persist_src-addr.json');

let json;

describe('Persist (source-addr): ltm persistence source-addr', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/persist_src-addr/persist_src-addr.conf']);
