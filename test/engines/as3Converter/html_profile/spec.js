...
const ex1 = require('./html_profile.json');

let json;

describe('HTML_Profile: ltm profile html', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/html_profile/html_profile.conf']);
