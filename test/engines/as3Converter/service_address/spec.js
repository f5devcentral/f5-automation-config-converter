...
const ex1 = require('./service_address.json');

let json;

describe('Service_Address: ltm virtual-address', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/service_address/service_address.conf']);
