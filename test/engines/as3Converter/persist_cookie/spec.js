...
const ex1 = require('./persist_cookie.json');

const persistCookieAllowlist = ['passphrase'];
let json;

describe('Persist (cookie): ltm persistence cookie', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/persist_cookie/persist_cookie.conf']);
        ...
        compareDeclaration(originalDec, convertedDec, persistCookieAllowlist);
    });
