...
const ex1 = require('./ca_bundle.json');

let json;

describe('CA_Chain: file sys ssl-cert', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/ca_bundle/ca_bundle.conf']);
        const caBundle = fs.readFileSync('./test/engines/as3Converter/ca_bundle/ca_bundle.crt', 'utf-8');
        const bundle = '/var/tmp/filestore_temp/files_d/AS3_Tenant_d/certificate_d/AS3_TenantAS3_ApplicationtestItem_124192_1';
        data[bundle] = caBundle;
