...
const ex1 = require('./http_compress.json');

let json;

describe('HTTP_Compress: ltm profile http-compression', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/http_compress/http_compress.conf']);
