...
const ex1 = require('./dns_cache.json');

let json;

describe('DNS_Cache: ltm dns cache transparent', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/dns_cache/dns_cache.conf']);
