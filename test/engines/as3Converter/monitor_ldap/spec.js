...
const ex1 = require('./monitor_ldap.json');

let json;

describe('Monitor LDAP: ltm monitor ldap', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/monitor_ldap/monitor_ldap.conf']);
