...
const ex1 = require('./cipher_group.json');

let json;

describe('Cipher_Group: ltm cipher group', () => {
    // Cipher Group
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/cipher_group/cipher_group.conf']);
