...
const ex1 = require('./sip_profile.json');

let json;

describe('SIP_Profile: ltm profile sip', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/sip_profile/sip_profile.conf']);
