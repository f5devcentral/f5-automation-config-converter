...
const ex1 = require('./icap_profile.json');

let json;

describe('ICAP_Profile: ltm profile icap', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/icap_profile/icap_profile.conf']);
