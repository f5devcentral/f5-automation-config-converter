...
const ex1 = require('./analytics_tcp_profile.json');

let json;

describe('Analytics_TCP_Profile: ltm profile tcp-analytics', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/analytics_tcp_profile/analytics_tcp_profile.conf']);
