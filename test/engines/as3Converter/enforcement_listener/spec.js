...
const ex1 = require('./enforcement_listener.json');

let json;

describe('Enforcement_Listener: pem listener', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/enforcement_listener/enforcement_listener.conf']);
