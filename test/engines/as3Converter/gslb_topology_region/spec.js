...
const ex1 = require('./gslb_topology_region.json');

let json;

describe('GSLB_Topology_Region: gtm region', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/gslb_topology_region/gslb_topology_region.conf']);
