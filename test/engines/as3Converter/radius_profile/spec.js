...
const ex1 = require('./radius_profile.json');

let json;

describe('Radius_Profile: ltm profile radius', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/radius_profile/radius_profile.conf']);
