...
const ex1 = require('./monitor_smtp.json');

let json;

describe('Monitor SMTP: ltm monitor smtp', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/monitor_smtp/monitor_smtp.conf']);
