...
const ex1 = require('./persist_hash.json');

let json;

describe('Persist (hash): ltm persistence hash', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/persist_hash/persist_hash.conf']);
