...
const ex1 = require('./enforcement_radius_aaa_profile.json');

const enforcementAllowlist = ['sharedSecret', 'password'];
let json;

describe('Enforcement_Radius_AAA_Profile: pem profile radius-aaa', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/enforcement_radius_aaa_profile/enforcement_radius_aaa_profile.conf']);
        ...
        compareDeclaration(originalDec, convertedDec, enforcementAllowlist);
    });
