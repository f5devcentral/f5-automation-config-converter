...
const ex1 = require('./monitor_radius.json');

let json;

describe('Monitor RADIUS: ltm monitor radius', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/monitor_radius/monitor_radius.conf']);
