...
const ex1 = require('./monitor_http.json');
const ex2 = require('./monitor_http2.json');
const ex3 = require('./monitor_http3.json');
const ex4 = require('./monitor_http4.json');

let json;

describe('Monitor HTTP: ltm monitor http', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/monitor_http/monitor_http.conf']);
    ...
    it('ex2', async () => {
        const data = await readFiles(['./test/engines/as3Converter/monitor_http/monitor_http2.conf']);
        const parsed = parse(data);
        json = as3Converter(parsed).declaration;
    ...
    it('ex3', async () => {
        const data = await readFiles(['./test/engines/as3Converter/monitor_http/monitor_http3.conf']);
        const parsed = parse(data);
        json = as3Converter(parsed).declaration;
    ...
    it('ex4', async () => {
        const data = await readFiles(['./test/engines/as3Converter/monitor_http/monitor_http4.conf']);
        const parsed = parse(data);
        json = as3Converter(parsed).declaration;
