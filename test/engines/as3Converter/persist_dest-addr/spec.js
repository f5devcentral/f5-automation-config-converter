...
const ex1 = require('./persist_dest-addr.json');

let json;

describe('Persist (dest-addr): ltm persistence dest-addr', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/persist_dest-addr/persist_dest-addr.conf']);
