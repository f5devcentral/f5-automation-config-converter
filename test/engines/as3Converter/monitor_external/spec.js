...
const ex1 = require('./monitor_external.json');

let json;

describe('Monitor External: ltm monitor external', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/monitor_external/monitor_external.conf']);
