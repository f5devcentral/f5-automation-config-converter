...
const ex1 = require('./enforcement_diameter_endpoint_profile.json');

let json;

describe('Enforcement_Diameter_Endpoint_Profile: pem profile diameter-endpoint', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/enforcement_diameter_endpoint_profile/enforcement_diameter_endpoint_profile.conf']);
