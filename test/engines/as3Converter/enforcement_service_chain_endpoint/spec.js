...
const ex1 = require('./enforcement_service_chain_endpoint.json');

let json;

describe('Enforcement_Service_Chain_Endpoint: pem service-chain-endpoint', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/enforcement_service_chain_endpoint/enforcement_service_chain_endpoint.conf']);
