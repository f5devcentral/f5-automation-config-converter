...
const ex1 = require('./classification_profile.json');

let json;

describe('Classification_Profile: ltm profile classification', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/classification_profile/classification_profile.conf']);
