...
const ex1 = require('./stream_profile.json');

let json;

describe('Stream_Profile: ltm profile stream', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/stream_profile/stream_profile.conf']);
