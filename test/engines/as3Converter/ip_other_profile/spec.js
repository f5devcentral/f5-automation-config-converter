...
const ex1 = require('./ip_other_profile.json');

let json;

describe('IP_Other_Profile: ltm profile ipother', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/ip_other_profile/ip_other_profile.conf']);
