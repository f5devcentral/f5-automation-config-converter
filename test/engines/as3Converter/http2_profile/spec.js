...
const ex1 = require('./http2_profile.json');

let json;

describe('HTTP2_Profile: ltm profile http2', async () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/http2_profile/http2_profile.conf']);
