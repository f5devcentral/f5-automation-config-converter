...
const ex1 = require('./websocket_profile.json');

let json;

describe('HTTP_Profile: ltm profile websocket', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/websocket_profile/websocket_profile.conf']);
