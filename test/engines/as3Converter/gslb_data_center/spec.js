...
const ex1 = require('./gslb_data_center.json');

let json;

describe('GSLB_Data_Center: gtm datacenter', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/gslb_data_center/gslb_data_center.conf']);
