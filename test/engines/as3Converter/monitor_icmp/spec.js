...
const ex1 = require('./monitor_icmp.json');

let json;

describe('Monitor ICMP: ltm monitor gateway-icmp', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/monitor_icmp/monitor_icmp.conf']);
