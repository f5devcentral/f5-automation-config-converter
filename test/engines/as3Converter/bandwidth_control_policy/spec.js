...
const ex1 = require('./bandwidth_control_policy.json');

let json;

describe('Bandwidth_Control_Policy: net bwc policy', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/bandwidth_control_policy/bandwidth_control_policy.conf']);
