...
const ex1 = require('./firewall_policy.json');
const ex2 = require('./firewall_policy2.json');

let json;

describe('Firewall_Policy: security firewall policy', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/firewall_policy/firewall_policy.conf']);
    ...
    it('ex2', async () => {
        const data = await readFiles(['./test/engines/as3Converter/firewall_policy/firewall_policy2.conf']);
        const parsed = parse(data);
        json = as3Converter(parsed).declaration;
