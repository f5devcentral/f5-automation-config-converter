...
const ex1 = require('./traffic_log_profile.json');

let json;

describe('Traffic_Log_Profile: ltm profile request-log', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/traffic_log_profile/traffic_log_profile.conf']);
