...
const ex1 = require('./firewall_address_list.json');

let json;

describe('Firewall_Address_List: security firewall address-list', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/firewall_address_list/firewall_address_list.conf']);
