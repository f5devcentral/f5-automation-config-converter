...
const ex1 = require('./defaultsFrom.json');

let json;

describe('defaults-from inheritance: Check merge parents parameters works fine', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/misc/defaultsFromInheritance/defaultsFrom.conf']);
