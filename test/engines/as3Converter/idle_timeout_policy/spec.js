...
const ex1 = require('./idle_timeout_policy.json');

let json;

describe('Idle_Timeout_Policy: net timer-policy', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/idle_timeout_policy/idle_timeout_policy.conf']);
