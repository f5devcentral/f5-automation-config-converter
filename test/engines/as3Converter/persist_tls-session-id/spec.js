...
const ex1 = require('./persist_tls-session-id.json');

let json;

describe('Persist (TLS_Session): ltm persistence ssl', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/persist_tls-session-id/persist_tls-session-id.conf']);
