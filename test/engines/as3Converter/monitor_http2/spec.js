...
const ex1 = require('./monitor_http2.json');

let json;

describe('Monitor HTTP2: ltm monitor http2', async () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/monitor_http2/monitor_http2.conf']);
