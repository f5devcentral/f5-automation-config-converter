...
const ex1 = require('./enforcement_profile.json');

let json;

describe('Enforcement_Profile: pem profile spm', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/enforcement_profile/enforcement_profile.conf']);
