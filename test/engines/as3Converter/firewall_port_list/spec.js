...
const ex1 = require('./firewall_port_list.json');
const ex2 = require('./firewall_port_list2.json');

let json;

describe('Firewall_Port_List: security firewall port-list', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/firewall_port_list/firewall_port_list.conf']);
    ...
    it('ex2', async () => {
        const data = await readFiles(['./test/engines/as3Converter/firewall_port_list/firewall_port_list2.conf']);
        const parsed = parse(data);
        json = as3Converter(parsed).declaration;
