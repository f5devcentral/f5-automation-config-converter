...
const ex1 = require('./enforcement_policy.json');

let json;

describe('Enforcement_Policy: pem policy', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/enforcement_policy/enforcement_policy.conf']);
