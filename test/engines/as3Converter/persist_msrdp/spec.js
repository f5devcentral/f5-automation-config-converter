...
const ex1 = require('./persist_msrdp.json');

let json;

describe('Persist (msrdp): ltm persistence msrdp', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/persist_msrdp/persist_msrdp.conf']);
