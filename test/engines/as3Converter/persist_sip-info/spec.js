...
const ex1 = require('./persist_sip-info.json');

let json;

describe('Persist (sip-info): ltm persistence sip-info', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/persist_sip-info/persist_sip-info.conf']);
