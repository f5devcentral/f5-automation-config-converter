...
const ex1 = require('./monitor_mysql.json');

let json;

describe('Monitor MYSQL: ltm monitor mysql', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/monitor_mysql/monitor_mysql.conf']);
