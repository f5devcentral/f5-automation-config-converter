...
const ex1 = require('./gslb_prober_pool.json');

let json;

describe('GSLB_Prober_Pool: gtm prober-pool', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/gslb_prober_pool/gslb_prober_pool.conf']);
