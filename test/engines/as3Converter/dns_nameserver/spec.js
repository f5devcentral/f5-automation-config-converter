...
const ex1 = require('./dns_nameserver.json');

let json;

describe('DNS_Nameserver: ltm dns nameserver', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/dns_nameserver/dns_nameserver.conf']);
