...
const ex1 = require('./enforcement_format_script.json');

let json;

describe('Enforcement_Format_Script: pem reporting format-script', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/enforcement_format_script/enforcement_format_script.conf']);
