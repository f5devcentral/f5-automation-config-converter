...
const ex1 = require('./cipher_rule.json');

let json;

describe('Cipher_Rule: ltm cipher rule', () => {
    // Cipher Rule
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/cipher_rule/cipher_rule.conf']);
