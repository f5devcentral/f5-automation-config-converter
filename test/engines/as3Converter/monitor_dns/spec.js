...
const ex1 = require('./monitor_dns.json');

let json;

describe('Monitor DNS: ltm monitor dns', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/monitor_dns/monitor_dns.conf']);
