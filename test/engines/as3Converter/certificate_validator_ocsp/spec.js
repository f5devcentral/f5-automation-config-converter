...
const ex1 = require('./certificate_validator_ocsp.json');

let json;

describe('Certificate_Validator_OCSP: ltm profile ocsp-stapling-params', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/as3Converter/certificate_validator_ocsp/certificate_validator_ocsp.conf']);
