...
const ex1 = require('./gslbdatacenter.json');

let declaration;

describe('GSLBDataCenter: gtm datacenter', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/doConverter/gslbdatacenter/gslbdatacenter.conf']);
