...
const ex1 = require('./gslbglobals.json');

let declaration;

describe('GSLBGlobals: gtm global-settings', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/doConverter/gslbglobals/gslbglobals.conf']);
