...
const ex1 = require('./failoverunicast.json');

let declaration;

describe('FailoverUnicast: cm device', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/doConverter/failoverunicast/failoverunicast.conf']);
