...
const ex1 = require('./trafficgroup.json');

let declaration;

describe('TrafficGroup: cm traffic-group', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/doConverter/trafficgroup/trafficgroup.conf']);
