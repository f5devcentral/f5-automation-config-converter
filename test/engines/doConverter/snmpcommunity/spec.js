...
const ex1 = require('./snmpcommunity.json');

let declaration;

describe('SnmpCommunity: sys snmp', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/doConverter/snmpcommunity/snmpcommunity.conf']);
