...
const ex1 = require('./snmptrapdestination.json');

let declaration;

describe('SnmpTrapDestination: sys snmp', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/doConverter/snmptrapdestination/snmptrapdestination.conf']);
