...
const ex1 = require('./firewallpolicy.json');

let declaration;

describe('FirewallPolicy: security firewall policy', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/doConverter/firewallpolicy/firewallpolicy.conf']);
