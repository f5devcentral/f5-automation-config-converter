...
const ex1 = require('./firewalladdresslist.json');

let declaration;

describe('FirewallAddressList: security firewall address-list', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/doConverter/firewalladdresslist/firewalladdresslist.conf']);
