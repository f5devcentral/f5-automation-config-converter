...
const ex1 = require('./routingprefixlist.json');

let declaration;

describe('RoutingPrefixList: net routing prefix-list', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/doConverter/routingprefixlist/routingprefixlist.conf']);
