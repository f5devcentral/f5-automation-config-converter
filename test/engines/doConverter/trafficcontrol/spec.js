...
const ex1 = require('./trafficcontrol.json');

let declaration;

describe('TrafficControl: ltm global-settings traffic-control', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/doConverter/trafficcontrol/trafficcontrol.conf']);
