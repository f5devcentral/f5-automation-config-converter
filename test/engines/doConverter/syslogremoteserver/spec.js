...
const ex1 = require('./syslogremoteserver.json');

let declaration;

describe('SyslogRemoteServer: sys syslog', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/doConverter/syslogremoteserver/syslogremoteserver.conf']);
