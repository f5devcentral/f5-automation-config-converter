...
const ex1 = require('./failovermulticast.json');

let declaration;

describe('FailoverMulticast: cm device', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/doConverter/failovermulticast/failovermulticast.conf']);
