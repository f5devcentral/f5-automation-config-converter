...
const ex1 = require('./routingaspath.json');

let declaration;

describe('RoutingAsPath: net routing as-path', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/doConverter/routingaspath/routingaspath.conf']);
