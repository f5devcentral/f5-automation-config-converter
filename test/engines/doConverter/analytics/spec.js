...
const ex1 = require('./analytics.json');

let declaration;

describe('Analytics: analytics global-settings', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/doConverter/analytics/analytics.conf']);
