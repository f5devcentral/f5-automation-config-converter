...
const ex1 = require('./routingaccesslist.json');

let declaration;

describe('RoutingAccessList: net routing access-list', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/doConverter/routingaccesslist/routingaccesslist.conf']);
