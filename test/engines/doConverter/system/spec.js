...
const ex1 = require('./system.json');

let declaration;

describe('System: sys software update, sys global-settings, cli global-settings', () => {
    it('ex1', async () => {
        const data = await readFiles(['./test/engines/doConverter/system/system.conf']);
